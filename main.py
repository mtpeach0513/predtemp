...
parser.add_argument('--model', type=str, required=True, default='transformer',
                    help='model of experiment, options: [informer, informerstack, transformer]')

parser.add_argument('--data', type=str, required=True, default='custom', help='data')
parser.add_argument('--root_path', type=str, default='./data/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='dataset.csv', help='data file')
parser.add_argument('--features', type=str, default='MS',
                    help='forecasting task, options:[M, S, MS]; M:multivariate predict multivariate, S:univariate predict univariate, MS:multivariate predict univariate')
parser.add_argument('--target', type=str, default='A_temp', help='target feature in S or MS task')
